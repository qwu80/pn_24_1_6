        ...
        if ( sceneCount ==2 || sceneCount ==3){
            ...
            if (this.color ==1){
                ...
                try {
                    ...
                    if (this.color ==1 &&this.straight==0 && this.position2.x >= (line_green_data[this.near_index].x-E_gap_factor-10 )) 
                ...
                try {
                    ...
                    // if (this.near_index<50)  {
                        ...
                        if (this.color ==0  &&this.straight==0&& this.position2.x <= (line_yellow_data[this.near_index].x+E_gap_factor+10 )) 
